...
# Social AI
Imagine, your AI is not only interacting with you, but it's also interacting with others - talking and taking actions. 
As the AI is interacting, we also want it to update their memory and worldview. 
Imaigne an AI Agent that is speaking to people on the internet, and people make your agent believe that the earth is flat. 
Now when you use the same AI agent for your own research, you will get skewed information. Potentially wrong answers. 
...
Not just that, AI has the power to bring efficiencies to society. But these usecases aren't even being discussed, because verifiablity of prompts is a messy problem to solve.
