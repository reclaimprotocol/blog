...
India has a new Data Protection regulation, similar to GDPR - called [DPDP](https://www.meity.gov.in/static/uploads/2024/06/2bf1f0e9f04e6fb4f8fef35e82c42aa5.pdf) that has been in effect since 2023. The goal of the regulation is, like that of GDPR, is to keep user's data protected - and curtail impacts from data breaches. 
