...
No matter how good the defensive AI is, as [this paper showed](https://arxiv.org/abs/1808.01976), an attacker could query the system 1000 times to learn everything there is to learn about the AI's internals even when the system is closed source. Once done, they could generate a document or image that will fool the defensive AI every single time.
